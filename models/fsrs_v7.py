...
class FSRS7(FSRS6):
    ...
    def __init__(self, config: Config, w: Optional[List[float]] = None):
        ...
        self._l2_sigma = torch.tensor(
            [
                9999.0, 9999.0, 9999.0, 9999.0, 0.523, 0.2528, 0.4329, 0.2966, 0.2139,
                0.2889, 0.1862, 0.0829, 0.175, 0.3812, 0.3013, 0.9104, 0.3234, 0.2448,
                0.3273, 0.1842, 0.1542, 0.1735, 0.4608, 0.311, 0.864, 0.4053, 0.162,
